      ...
      <div className="flex flex-col gap-6 sm:gap-8">
        ...
        <div className="flex flex-col gap-10 sm:gap-[80px]">
          <pre className="whitespace-pre-wrap text-sm font-medium leading-6 text-gray-950 sm:text-base">
            ...
            거북목증후군은 목이 정상적인 위치보다 앞으로 돌출되면서 척추 그자체와 해당부분과
            이어지는 날개뼈 및 어깨에까지 영향을 끼칠 수 있는 만성적 질환입니다. 장시간 목을
            숙인상태로 컴퓨터를 사용하거나, 스마트폰 시청처럼 고개를 숙인 자세가 지속되면 근육간의
            균형이 깨지고 뭉쳐서, 주변 표피신경의 포착증상으로 진행되게 되면 목 주변 및 어깨죽지,
            날개죽지의 만성적인 통증과 피로를 유발합니다. 시간이 지나면 어깨 결림이나 팔 저림 같은
