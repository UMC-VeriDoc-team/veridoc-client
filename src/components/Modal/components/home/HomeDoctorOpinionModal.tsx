...
const HomeDoctorOpinionModal = () => {
  ...
  return (
    <div className="relative flex h-[900px] max-h-[900px] w-[92vw] max-w-[700px] flex-col rounded-xl bg-white sm:min-w-[380px]">
      <div className="overflow-y-scroll p-11">
        {/* 모달 닫기 */}
        <button type="button" onClick={() => closeModal()} className="w-full">
          <Icon name="close" className="absolute right-4 top-4 h-3 w-3 cursor-pointer" />
        </button>
        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="flex flex-col space-y-2">
            <p className="text-4xl font-extrabold text-gray-950">반복되는 두통과 어깨 결림,</p>
            <p className="text-4xl font-extrabold text-gray-950">거북목증후군을 의심해보세요</p>
          </div>

          <div className="flex flex-col gap-3">
            <div className="flex items-center gap-4">
              <Icon name="doctor" className="h-12 w-12 rounded-full" />
              <p className="text-base font-medium text-gray-950">관련 전문의 답변</p>
            </div>
            ...
            <div className="flex justify-between">
              <div className="flex gap-2">
                <div className="flex gap-1 border border-brand-primary px-2 py-1">
                  ...
                  <p className="pt-[2px] text-center text-base font-medium text-brand-primary">
                    공개 의료 Q&A
                  </p>
                </div>
                <div className="flex gap-1 border border-brand-green px-2 py-1">
                  <Icon name="check-fill-green" className="w-4" />
                  <p className="pt-[2px] text-center text-base font-medium text-brand-green">
                    export
                  </p>
                </div>
              </div>
              <button type="button" className="flex items-center justify-center gap-2">
                <p className="text-center text-base font-medium text-gray-200">원문 출처 보기</p>
          ...
          {/* 이미지 */}
          <div className="h-[260px] w-full rounded-[10px] bg-gray-100"></div>

          {/* 본문 / 경고문 */}
          <div className="flex flex-col gap-[80px]">
            <pre className="whitespace-pre-wrap text-base font-medium text-gray-950">
            ...
            {/* 경고문 */}
            <div className="flex w-full items-center gap-5 rounded-md border border-brand-orange px-4 py-4">
              ...
              <div className="flex gap-5">
                {posts.map((post) => (
                  <div className="flex cursor-pointer flex-col gap-2">
                    <div className="h-32 w-60 bg-gray-100"></div>
