...
export const GUIDE_DETAIL_CONTENTS: Record<GuideDetailType, GuideDetailContent> = {
  COMMON_SYMPTOMS: {
    ...
    header: {
      ...
      imageSrc: "/images/home/guides/modal/guide-common-symptoms.svg",
    },
    source: {
      name: "국민건강보험공단 건강정보",
      link: "",
  ...
  NEED_HOSPITAL: {
    ...
    header: {
      ...
      imageSrc: "/images/home/guides/modal/guide-need-hospital.svg",
    },
    source: {
      name: "국민건강보험공단 건강정보",
      link: "",
  ...
  DAILY_CARE: {
    ...
    header: {
      ...
      imageSrc: "/images/home/guides/modal/guide-daily-care.svg",
    },
    source: {
      name: "국민건강보험공단 건강정보",
      link: "",
  ...
  HOW_TO_USE: {
    ...
    header: {
      ...
      imageSrc: "/images/home/guides/modal/guide-how-to-use.svg",
    },
    source: {
      name: "국민건강보험공단 건강정보",
      link: "",
