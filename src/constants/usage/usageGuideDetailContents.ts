import type {
  GuideDetailContent,
  GuideDetailType,
} from "@/components/Modal/types/usageGuideDetail";

export const USAGE_GUIDE_DETAIL_CONTENTS: Record<GuideDetailType, GuideDetailContent> = {
  COMMON_SYMPTOMS: {
    cardNumber: 1,
    header: {
      title: "이런 증상은 흔해요",
      subtitle: "비슷한 증상들을 모아 원인을 분석해 드려요",
      imageSrc: "/images/usage/modal/common-symptoms.svg",
    },
    source: {
      name: "국민건강보험공단 건강정보",
      link: "",
  ...
  NEED_HOSPITAL: {
    ...
    header: {
      ...
      imageSrc: "/images/usage/modal/need-hospital.svg",
    },
    source: {
      name: "국민건강보험공단 건강정보",
      link: "",
  ...
  DAILY_CARE: {
    ...
    header: {
      ...
      imageSrc: "/images/usage/modal/daily-care.svg",
    },
    source: {
      name: "국민건강보험공단 건강정보",
      link: "",
  ...
  HOW_TO_USE: {
    ...
    header: {
      ...
      imageSrc: "/images/usage/modal/how-to-use.svg",
    },
    source: {
      name: "국민건강보험공단 건강정보",
      link: "",
