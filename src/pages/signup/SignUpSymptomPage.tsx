    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex min-h-screen flex-col bg-white pt-9 md:hidden">
        ...
        <div className="flex justify-center">
          {/* 모바일 컨텐츠 폭 354 기준으로 */}
          <main className="flex w-full max-w-[354px] flex-col items-start px-0">
            <div className="h-5" />

            {/* 왼쪽 정렬 + 줄바꿈 */}
            <div className="flex w-full flex-col items-start gap-2 px-1">
              <h1 className="whitespace-pre-line text-left text-[32px] font-extrabold leading-[1.4] tracking-[-0.025em] text-brand-primary">
                주로 아픈 곳을{"\n"}선택해주세요!
              </h1>

              <p className="whitespace-pre-line text-left text-[17px] font-medium leading-[1.4] tracking-[-0.025em] text-gray-950">
                선택한 부위를 기반으로 대처 가이드와 병원 정보를{"\n"}추천해드립니다 필요하다면
                증상을 선택하지 않고 {"\n"}넘어갈 수도 있어요
              </p>
            </div>
