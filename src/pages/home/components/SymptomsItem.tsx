...
const SymptomsItem = ({ key, iconName, symptomsName, description }: SymptomsItemProps) => {
  return (
    <div
      id={key}
      className="flex h-[186px] flex-col items-center justify-center gap-y-3 rounded-[20px] bg-white px-4 shadow-[0_6.48px_54.9px_rgba(0,134,255,0.1)] md:h-[316px] md:gap-y-6 md:px-6 md:transition-all md:duration-300 md:ease-out md:hover:-translate-y-2 md:hover:shadow-[0_12px_70px_rgba(0,134,255,0.18)]"
    >
