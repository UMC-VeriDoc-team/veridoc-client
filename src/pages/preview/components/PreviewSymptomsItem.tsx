...
interface PreviewSymptomsItemProps {
  iconName: string;
  symptomsName: string;
  description: string;
}
...
// 프리뷰 증상 부위 소개
const PreviewSymptomsItem = ({ iconName, symptomsName, description }: PreviewSymptomsItemProps) => {
  return (
...
export default PreviewSymptomsItem;
