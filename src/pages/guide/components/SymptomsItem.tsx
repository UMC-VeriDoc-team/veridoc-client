...
const SymptomsItem = ({ iconName, symptomsName, description }: SymptomsItemProps) => {
  return (
    <div className="flex h-[316px] flex-col items-center justify-center gap-y-6 rounded-[20px] bg-white px-6 shadow-[0_6.48px_54.9px_rgba(0,134,255,0.1)] transition-all duration-300 ease-out hover:-translate-y-2 hover:shadow-[0_12px_70px_rgba(0,134,255,0.18)]">
